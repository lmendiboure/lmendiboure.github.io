# Session authoring template — MACU pattern

## A. Durable learning outcomes
...
**CHALLENGE** — one counterexample/change:
...
## E. Scaffolding ladder for unfamiliar content

1. Concrete problem:
2. Plain-language model:
3. Visual/network/process shape:
4. Family/category:
5. Technical name:
6. Essential explanation:
7. Optional vocabulary:
8. Expert nuance:
9. Transfer decision:

## F. Transfer cases

| Case | Surface features changed | Principle reused | Missing information / ambiguity |
|---|---|---|---|
| | | | |
| | | | |
...
| Mechanic | Learning function | Keep? |
|---|---|---|
| Mission framing | | |
| Progressive reveal | | |
| Confidence | | |
...
- [ ] Every important activity produces an artifact or explanation.
- [ ] Every STOP shows the student artifact.
- [ ] Every STOP has exactly one strong compare question.
