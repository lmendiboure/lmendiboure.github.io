# Ancrage narratif et preuves — Mission Vallée des Aldudes

## 1. Règle de séparation réel / fiction

Le cours adopte un **territoire réel** mais une **mission fictive**.
...
- la cellule d'étude confiée aux étudiants ;
- les horaires des épisodes ;
- Maialen, Peio, Inès et Samir ;
- les messages, incidents et arbitrages de séance ;
- l'architecture numérique construite par les groupes.
...
Indique un risque de crue torrentielle ou à montée rapide et référence l'AZI « Nive des Aldudes » couvrant notamment Aldudes, Banca et Urepel.

### HydroPortail — station Q916461001
https://www.hydro.eaufrance.fr/stationhydro/Q916461001/fiche

Station « La Nive des Aldudes à Saint-Étienne-de-Baïgorry », mise en service en 1960. Finalités affichées : suivi d'étiage et prévision des crues.

### Communauté Pays Basque — tiers-lieu Olha à Banca
...
Le projet a été adapté avec construction hors zone à risque de crue ; la page mentionne aussi reconstruction de la station d'épuration de Banca et travaux de confortement des berges.

### Insee — commune des Aldudes
...
### Vlachopoulos & Makri, 2024 — systematic review
https://doi.org/10.1016/j.stueduc.2024.101425

Revue systématique de 94 articles sur l'authentic assessment en enseignement supérieur. Les auteurs rapportent notamment des effets sur des compétences telles que pensée critique, résolution de problème et collaboration, tout en signalant des conditions de mise en œuvre.

### Sokhanvar, Salehi & Sokhanvar, 2021 — systematic review
https://doi.org/10.1016/j.stueduc.2021.101030

La revue identifie des avantages associés aux évaluations authentiques pour l'expérience d'apprentissage et l'engagement, sans justifier pour autant que toute « mise en situation » soit automatiquement efficace.

### Quinlan, Sellei & Fiorucci, 2024 — meaningful engagement
https://doi.org/10.1080/13562517.2024.2394042

Analyse de 302 explications d'étudiants sur leurs évaluations les plus engageantes. La connexion au monde réel apparaît, mais le **choix** est cité encore plus souvent. Conséquence pour le cours : le décor réel ne suffit pas ; les étudiants doivent conserver de vrais arbitrages.

### Prudence

Le cours n'infère pas de ces travaux qu'une narration produit mécaniquement de meilleurs apprentissages. Le design maintient donc les invariants du cours IoT : artefacts, comparaison, challenge, formalisation, transfert, retrieval et révision. La narration sert d'ancrage et de continuité.
