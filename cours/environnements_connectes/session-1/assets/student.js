(() => {
  ...
  function gate(screen,index){
    ...
    if(screen===3&&index===4){if(state.floodChain.filter(Boolean).length<5)return 'Complétez les cinq niveaux du cas de Banca avant la restitution.';}
